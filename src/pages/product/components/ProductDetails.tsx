...
const ProductDetails: React.FC<{ product: { description: string } }> = ({ product }) => {
    ...
    return (
        <Tabs defaultValue="description" className="w-full shadow-lg rounded-md">
            ...
            <TabsContent value="description" className="text-start ms-2"> <p>{product.description}</p></TabsContent>
